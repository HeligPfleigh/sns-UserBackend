...
export const auth = {
  ...
  firebaseAdmin: {
    ...
    project_id: process.env.FIREBASE_PROJECT_ID || 'snschat-fb64b',
    private_key_id: process.env.FIREBASE_PRIVATE_KEY_ID || 'fff4e9878722503cb5e8bcfd7536ea3cda4a7e16',
    ...
    client_email: process.env.FIREBASE_CLIENT_EMAIL || 'firebase-adminsdk-1gt28@snschat-fb64b.iam.gserviceaccount.com',
    client_id: process.env.FIREBASE_CLIENT_ID || '100137623575146372755',
