              ...
              <div className={s.form_bottom}>
                <form role="form" action="" method="post">
                  <div className="form-group">
                    ...
                    <input type="text" name="form_username" placeholder="Username..." className="form_username form-control" id="form_username" />
                  </div>
                  <div className="form-group">
                    <label className="sr-only" htmlFor="form_password">Password</label>
                    <input type="password" name="form_password" placeholder="Password..." className="form_password form-control" id="form_password" />
                  </div>
